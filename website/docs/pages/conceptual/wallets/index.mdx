...
- An account is a data entry that exist in the chain ledger, each account is identified by a unique address ([DID](../did)).
...
- A user need at least one account before they can send and receive transactions on the chain.
